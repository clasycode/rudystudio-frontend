            ...
            <div className={styles.modal__body}>
              ...
              >
                <div className={styles.form__title}>
                  Ваше имя может стать началом чего-то великого
                </div>
                <div className={styles.form__text}>
                  Укажите номер на котором есть Whatsapp или Telegram Мы
                  свяжемся с вами в течение 20 минут для обсуждения вашего
                  проекта.
                </div>
